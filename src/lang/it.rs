...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete RemoteConnect..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), RemoteConnect potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare RemoteConnect a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a RemoteConnect il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a RemoteConnect il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a RemoteConnect di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [RemoteConnect Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RemoteConnect background service", "Mantieni il servizio di RemoteConnect in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione RemoteConnect, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show RemoteConnect", "Visualizza RemoteConnect"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a RemoteConnect 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a RemoteConnect."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di RemoteConnect."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password RemoteConnect"),
        ...
        ("Exit", "Esci da RemoteConnect"),
        ("Open", "Apri RemoteConnect"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare RemoteConnect e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna RemoteConnect Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di RemoteConnect come lato controllato."),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra RemoteConnect è aperta"),
        ...
        ("About RemoteConnect", "Info su RemoteConnect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client RemoteConnect remoto alla versione {} o successiva!"),
