...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till RemoteConnect..."),
        ...
        ("install_tip", "På grund av UAC, kan inte RemoteConnect fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera RemoteConnect på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge RemoteConnect \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge RemoteConnect \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [RemoteConnect Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RemoteConnect background service", "Behåll RemoteConnect i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa RemoteConnect programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show RemoteConnect", "Visa RemoteConnect"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
