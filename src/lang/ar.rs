...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة RemoteConnect..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. RemoteConnect قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت RemoteConnect في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح RemoteConnect اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح RemoteConnect اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ RemoteConnect باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [RemoteConnect Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep RemoteConnect background service", "ابق خدمة RemoteConnect تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق RemoteConnect, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show RemoteConnect", "عرض RemoteConnect"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من RemoteConnect اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح RemoteConnect اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في RemoteConnect الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور RemoteConnect"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ترقية خادم RemoteConnect Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع RemoteConnect"),
        ...
        ("About RemoteConnect", "حول RemoteConnect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل RemoteConnect البعيد إلى {}"),
