...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de RemoteConnect..."),
        ...
        ("install_tip", "En alguns casos és possible que el RemoteConnect no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el RemoteConnect al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al RemoteConnect els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al RemoteConnect els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al RemoteConnect l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «RemoteConnect Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep RemoteConnect background service", "Manté el servei del RemoteConnect en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del RemoteConnect, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show RemoteConnect", "Mostra el RemoteConnect"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al RemoteConnect els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al RemoteConnect els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del RemoteConnect en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del RemoteConnect"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del RemoteConnect, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el RemoteConnect Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el RemoteConnect funcioni correctament com a equip controlable."),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del RemoteConnect està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del RemoteConnect en rerefons"),
        ...
        ("About RemoteConnect", "Quant al RemoteConnect"),
