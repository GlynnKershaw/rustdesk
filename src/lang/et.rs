...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "RemoteConnecti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa RemoteConnect mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et RemoteConnect oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb RemoteConnectile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb RemoteConnectile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma RemoteConnectile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [RemoteConnect Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RemoteConnect background service", "Säilita RemoteConnecti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele RemoteConnecti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show RemoteConnect", "Kuva RemoteConnect"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma RemoteConnectile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma RemoteConnectile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud RemoteConnecti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita RemoteConnecti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul RemoteConnecti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda RemoteConnect Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib RemoteConnectil takistada juhitud poolel toimimist."),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui RemoteConnecti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada RemoteConnecti taustateenust."),
        ...
        ("About RemoteConnect", "RemoteConnecti teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage RemoteConnecti klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
