...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään RemoteConnect verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa RemoteConnect ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RemoteConnectin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava RemoteConnectille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava RemoteConnectille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten RemoteConnect daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota RemoteConnectille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli RemoteConnect ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "RemoteConnect palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa RemoteConnectin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "RemoteConnect palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep RemoteConnect background service", "Pidä RemoteConnectin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista RemoteConnectin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show RemoteConnect", "Näytä RemoteConnect"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista RemoteConnect salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "RemoteConnect ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä RemoteConnect Server Pro versioon {} jatkaaksesi."),
        ...
        ("About RemoteConnect", "Tietoa RemoteConnectistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-RemoteConnect-asiakasversioon {} yhteensopivuuden takaamiseksi"),
